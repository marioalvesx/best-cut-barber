...
import { MapPin, Phone, Mail, Clock, Calendar, User, MessageCircle } from 'lucide-react'
...
export default function Contact() {
  ...
  const whatsappMessage = 'Olá! Gostaria de agendar um horário na Best Cut Barber.'
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16 scroll-reveal">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Entre em contato conosco para agendar seu horário ou esclarecer dúvidas. 
            ...
            <Card className="bg-gray-900/50 border-gray-800">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-300">contato@bestcutbarber.com.br</span>
                </div>
                <Button 
            ...
            <Card className="bg-gray-900/50 border-gray-800">
              ...
              <CardContent className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-primary font-semibold">8:00 - 20:00</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-primary font-semibold">8:00 - 18:00</span>
                </div>
                <div className="flex justify-between">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent className="bg-gray-800 border-gray-700">
                          <SelectItem value="corte-classico">Corte Clássico - R$ 45</SelectItem>
                          <SelectItem value="barba-profissional">Barba Profissional - R$ 35</SelectItem>
                          <SelectItem value="estilizacao">Estilização - R$ 55</SelectItem>
                          <SelectItem value="barba-completa">Barba Completa - R$ 65</SelectItem>
                          <SelectItem value="corte-barba">Corte + Barba - R$ 70</SelectItem>
                  ...
                  <p className="text-xs text-gray-400 text-center">
                    * Campos obrigatórios. Seus dados estão seguros e serão usados apenas para agendamento.
                  </p>
                </form>
              </CardContent>
            </Card>
