      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="text-center mb-16 scroll-reveal">
          ...
          <p className="text-lg text-gray-300 max-w-3xl mx-auto">
            Confira alguns dos nossos melhores trabalhos. Cada corte é uma obra de arte, 
            personalizada para realçar o melhor de cada cliente.
          </p>
        </div>
        ...
        <div className="mt-20 scroll-reveal">
          <div className="bg-gradient-to-r from-gray-900/80 to-gray-800/80 rounded-lg p-8 backdrop-blur-sm">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              <div className="group">
                <div className="text-4xl font-bold text-primary mb-2 count-animation">800+</div>
                <p className="text-gray-300">Cortes por Mês</p>
              </div>
              <div className="group">
                <div className="text-4xl font-bold text-primary mb-2 count-animation">600+</div>
                <p className="text-gray-300">Barbas por Mês</p>
              </div>
              <div className="group">
                <div className="text-4xl font-bold text-primary mb-2 count-animation">400+</div>
                <p className="text-gray-300">Estilizações por Mês</p>
              </div>
              <div className="group">
                <div className="text-4xl font-bold text-primary mb-2 count-animation">98%</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="bg-gray-900/50 border-gray-800 p-6">
              ...
              <p className="text-gray-300 italic">
                "Excelente atendimento e qualidade incomparável. Sempre saio satisfeito com o resultado. 
                Os profissionais são muito talentosos!"
              </p>
            ...
            <Card className="bg-gray-900/50 border-gray-800 p-6">
              ...
              <p className="text-gray-300 italic">
                "A melhor barbearia de Porto Alegre! Ambiente acolhedor, profissionais experientes 
                e resultado sempre perfeito. Recomendo!"
              </p>
              <div className="flex text-primary text-sm mt-3">★★★★★</div>
            </Card>
            ...
            <Card className="bg-gray-900/50 border-gray-800 p-6">
              ...
              <p className="text-gray-300 italic">
                "Frequento a Best Cut há 3 anos. Qualidade consistente, preços justos e 
                sempre conseguem o estilo que eu quero. Top demais!"
              </p>
              <div className="flex text-primary text-sm mt-3">★★★★★</div>
            </Card>
          </div>
